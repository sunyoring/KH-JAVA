...
//	}
	...
	@Override
	public int compareTo(Object o) {//내림차순2
	...
	*/
	...
	public int compareTo(Object o) { //오름차순
		...
		System.out.println("this : " + (this.tNum) + ", object : " + (((Travel)o).tNum) + ", return : " + country.compareTo(((Travel)o).country));
