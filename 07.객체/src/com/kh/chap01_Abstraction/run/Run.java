...
public class Run {
	...
	public static void main(String[] args) {
		...
		//1. 클래스를 만들고 나서 자바의 객체 형태로 만들기 위해서는 new 라는 연산자를 통해 heap영역에 생성해야 함. (즉, 공간할당)
		Student u = new Student(); //---> 객체 생성 : new연산자를 통해 heap영역에 공간이만들어짐
		...
		/* 
		 * public으로 작업을 하게 되면 외부에서 직접 접근을 통해서 값이 변질되거나 마음대로 조회할 수 있다.
		 * 
		 * --> 캡슐화 작업을 해야 함.
		 * --> 객체지향 설계원칙 중 정보은닉 기술 중 일부분이 캡슐화라는 것
		 * */
	}
