...
public class A_UnCheckedException {
	...
	public void method1() {
		...
		System.out.println("resutl : " + result); // 사용자가 num2에 0을 입력하면 비정상적으로 종료
...
//		}
	...
	public void method3() {
		...
		try {
			...
			/*
			 * } catch(ClassCastException e) { System.out.println("형변환 문제");
			 * }catch(ArrayIndexOutOfBoundsException e) { System.out.println("배열 크기 문제 ");
			 * }catch(NullPointerException e){ System.out.println("객체 생성 x"); }
			 */
			/*Multi catch문 --> 나란히 작성하는 경우 형제레벨만 함께 사용*/
		} catch (ClassCastException | ArrayIndexOutOfBoundsException | NullPointerException e) {
			System.out.println("객체 생성 x");
			e.printStackTrace();
